...
if __name__ == "__main__":
    ...
    fig.write_html(str(output_dir / "10_production_readiness_scores.html"), include_plotlyjs=True)
    ...
    fig_dark.write_html(str(output_dir / "10_production_readiness_scores_dark.html"), include_plotlyjs=True)
