...
if __name__ == "__main__":
    ...
    fig.write_html(str(output_dir / "03_algorithm_comparison_radar.html"), include_plotlyjs=True)
    ...
    fig_dark.write_html(str(output_dir / "03_algorithm_comparison_radar_dark.html"), include_plotlyjs=True)
