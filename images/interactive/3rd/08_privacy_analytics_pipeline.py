...
if __name__ == "__main__":
    ...
    fig.write_html(str(output_dir / "08_privacy_analytics_pipeline.html"), include_plotlyjs=True)
    ...
    fig_dark.write_html(str(output_dir / "08_privacy_analytics_pipeline_dark.html"), include_plotlyjs=True)
