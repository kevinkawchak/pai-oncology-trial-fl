...
if __name__ == "__main__":
    ...
    fig.write_html(str(output_dir / "10_oncology_trajectories.html"), include_plotlyjs=True)
    ...
    fig_dark.write_html(str(output_dir / "10_oncology_trajectories_dark.html"), include_plotlyjs=True)
