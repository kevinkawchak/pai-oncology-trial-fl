...
if __name__ == "__main__":
    ...
    fig.write_html(str(output_dir / "05_parameter_mapping_heatmap.html"), include_plotlyjs=True)
    ...
    fig_dark.write_html(str(output_dir / "05_parameter_mapping_heatmap_dark.html"), include_plotlyjs=True)
