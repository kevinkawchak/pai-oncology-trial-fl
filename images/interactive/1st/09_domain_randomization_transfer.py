...
if __name__ == "__main__":
    ...
    fig.write_html(str(output_dir / "09_domain_randomization_transfer.html"), include_plotlyjs=True)
    ...
    fig_dark.write_html(str(output_dir / "09_domain_randomization_transfer_dark.html"), include_plotlyjs=True)
